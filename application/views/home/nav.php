    ...
    <div class="pos-f-t">
        ...
        <nav class="navbar navbar-dark bg-nine">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <form>
                    <?php if($userdata['logged_in']){ ?>
                        <button class="btn bg-four btn-sm hvr-bounce-in" id="logout_btn"><i class="fa fa-sign-out"></i> Déconnection</button>
                    <?php } else {?>
                        <button class="btn bg-four btn-sm hvr-bounce-in" id="log_in" type="submit"><i class="fa fa-sign-out"></i><a class="tx-eight" href="http://localhost/AStream/index.php/login">Connection</a></button>
                    <?php }?>
                </form>
            </button>
        </nav>

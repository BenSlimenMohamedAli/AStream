...
<!--Footer-->
<footer class="page-footer font-small bg-seven pt-0">
    ...
    <div class="container">
        ...
        <div class="row pt-5 mb-3 text-center d-flex justify-content-center">
            ...
            <div class="col-md-2 mb-3">
                <h6 class="text-uppercase font-weight-bold">
                    <a href="http://localhost/AStream/">Accueil</a>
                </h6>
            </div>
            <!--Grid column-->
            ...
            <div class="col-md-2 mb-3">
                <h6 class="text-uppercase font-weight-bold">
                    <a href="http://localhost/AStream/index.php/panel">Panel</a>
                </h6>
            </div>
            <!--Grid column-->
        ...
        <div class="row d-flex text-center justify-content-center mb-md-0 mb-4">
            ...
            <div class="col-md-8 col-12 mt-5">
                <p style="line-height: 1.7rem">AStro streaming website</p>
...
echo script_tag('assets/js/plyr.js');
?>
</body>

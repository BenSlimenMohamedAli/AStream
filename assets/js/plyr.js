...
var Fullscreen = function () {
    function Fullscreen(player) {
        ...
        // Handle event (incase utilisateur presses escape etc)
...
var controls = {
    ...
    // TODO: rework this to utilisateur the getter in the API?
    ...
    createClass(Storage, [{
        ...
        get: function get$$1() {
            try {
                ...
                // Try to use it (it might be disabled, e.g. utilisateur is in private mode)
...
var Ads = function () {
    ...
    createClass(Ads, [{
         ...
         * mobile devices, this initialization is done as the result of a utilisateur action.
         */
        ...
        value: function play() {
            ...
            this.managerPromise.then(function () {
                // Initialize the container. Must be done via a utilisateur action on mobile devices
         ...
         * advertisement is playing, or when a utilisateur action is required to start, then we clear the
         * timer on ad ready
         * @param {number} time
         * @param {string} from
         */
...
var Plyr = function () {
    function Plyr(target, options) {
        ...
        // Setup local storage for utilisateur settings
    ...
    createClass(Plyr, [{
        ...
        /**
         * Toggle loop
         * TODO: Finish fancy new logic. Set the indicator on load as utilisateur may pass loop as config
